...
namespace Grocery.Core.Data.Repositories
{
    public class ClientRepository : IClientRepository
    {
        ...
        public ClientRepository()
        {
            ...
            var admin = clientList.FirstOrDefault(c => c.EmailAddress == "user3@mail.com"); //user3 in var admin stoppen
            if(admin != null) admin.Role = Role.Admin; //User3 krijgt Admin rol via net aangemaakte variabele
